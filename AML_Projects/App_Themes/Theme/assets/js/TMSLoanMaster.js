...
function GetFundDtls() {
    ...
    $.ajax({
        ...
        url: "TMSLoanMaster.aspx/getFundType",
...
function GetSubFundDtls() {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "TMSLoanMaster.aspx/getSubFund",
...
function GetFIType() {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "TMSLoanMaster.aspx/getFinancialType",
        data: "{QueryString:'" + QueryString + "'}",
        dataType: "json",
        success: function (Result) {
            $('#ddlFiTyp').empty();
...
function GetFIDetails() {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "TMSLoanMaster.aspx/getFIDtls",
        data: "{QueryString:'" + QueryString + "',input : '" + InputString + "'}",
        dataType: "json",
        success: function (Result) {
            $('#ddlFInst').empty();
...
function getFITableDtls() {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "TMSLoanMaster.aspx/getTable",
...
//        type: "POST",
//        contentType: "application/json; charset=utf-8",
//        url: "TMSLoanMaster.aspx/getBankLedg",
...
//        type: "POST",
//        contentType: "application/json; charset=utf-8",
//        url: "TMSLoanMaster.aspx/getloanLedg",
//        data: "{QueryStr:'" + QueryString + "'}",
//        dataType: "json",
//        success: function (Result) {
//            $('#ddlLoanAccn').empty();
...
function getGuarenteeType() {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "TMSLoanMaster.aspx/getPernlGurntee",
        data: "{QueryStr:'" + QueryString + "'}",
        dataType: "json",
        success: function (Result) {
            $('#ddlPrsnGrntee').empty();
...
function AddLoanMst() {
    ...
    var InputData = $("#ddlCatgry").val() + "µ" + $("#ddlsSubCat").val() + "µ" + $("#ddlFiTyp").val() + "µ" + $("#ddlFInst").val() + "µ" + $("#txt_AgrmntDt").val() + "µ" + $("#txt_DtAgrmntFrm").val() + "µ" + $("#txt_DtAgrmntTo").val() + "µ" + $("#txt_loan").val() + "µ" + $("[id*=hdUserId]").val() + "µ" + Guarntee + "µ" + gtype + "µ" + $("[id*=hdSerbank]").val() + "µ" + $("[id*=hdSerLoan]").val() + "µ" + $("[id*=hdBrid]").val() + "µ" + $("[id*=hdFirmId]").val() + "µ" + $("#txt_ROI").val() ;
        ...
        return false;
            ...
            type: "POST",
            contentType: "application/json; charset=utf-8",
            url: "TMSLoanMaster.aspx/AddLoanMaster",
