...
namespace AML_Projects
{
    ...
    public class ServiceViewDoc : System.Web.Services.WebService
    {
        ...
        public string DocumentsDownload(string QueryString, string QueryString1, string InputString)
        {
            ...
            if (InputString == "AttShow") { 
            ds = obj1.GetDetails("PROC_ITSM", "ITSM", InputString, QueryString, "", "");
            }
            else
            {
                ds = obj1.GetDetails("PROC_ITSM", "ITSM", "AttShowES", QueryString, "", "");
            }
