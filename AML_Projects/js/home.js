...
function funddtlAlertfilllist(data) {
    ...
    for (i = 0; i < valData.length - 1; i++) {
        valData1 = valData[i].split('µ');
       // $("#lstAlert").append("<li class='feed-item'><div class='alert-icon bg-danger'><i class='far fa-bell'></i></div>"+ valData1[0] +"<span class='ml-auto font-10 text-muted'>"+ valData1[1] +"</span></li>");
       // $("#lstAlert").append("<li class='feed-item font-10'><div class='alert-icon bg-danger'><i class='far fa-bell'></i></div>" + valData1[0] + "<span class='badge badge-pill badge-danger float-right'>" + valData1[1] + "</span></li>");
        $("#pnlAlerts").append("<div class='alert alert-recommend clearfix'><span class='alert-icon bg-orange'><i class='far fa-bell'></i></span><div class='notification-info'><ul class='clearfix notification-meta'><li class='pull-left notification-sender'><p><span><a href='#'>" + valData1[0] + "</a></span></p></li><li class='pull-right notification-time'>"+ valData1[1] +"</li></ul></div></div>");
    }
