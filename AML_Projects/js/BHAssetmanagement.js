...
function CheckAsstmngRitc() {
    ...
    $.ajax({
        ...
        url: "BHAssetmanagement.aspx/check_ritc_asstmng",
...
function UserAssetTview() {
    ...
    //}
        ...
        $('#tblticket').show();
    var Querystring = "ritcbhapprovalasst"; /*"WaitingForRITCVer";*/
        $.ajax({
            type: "POST",
            contentType: "application/json; charset=utf-8",
            ...
            success: function (Result) {
                if (Result.d.length > 0) {
                    $('#tblticket').empty();
                    $('#tblticket').append('<thead class="bg-success text-white">< tr ><th scope="col">Temporary Asset code</th><th scope="col">Asset Name</th><th scope="col">Manufacture Name</th> <th scope="col">Asset State</th></tr></thead><tbody class="border border-dark">');
...
//        type: "POST",
//        contentType: "application/json; charset=utf-8",
//        url: "BHAssetmanagement.aspx/getbran",
//        data: "{QueryString:'" + QueryString + "',input : '" + input + "'}",
//        dataType: "json",
//        success: function (Result) {
//            if (Result.d.length > 0) {
...
function GetBranchLst() {
    ...
    var InputString = $("[id*=hdUserId]").val();
     $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "BHAssetmanagement.aspx/getRitcBh",
...
function GetAssetstate() {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "BHAssetmanagement.aspx/getAssignto",
        data: "{QueryString:'" + QueryString + "'}",
        dataType: "json",
        success: function (Result) {
            $('#ddlassetstate').empty();
...
function Getassettype() {
    ...
    $.ajax({
        ...
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "BHAssetmanagement.aspx/getAssettype",
        data: "{QueryString:'" + QueryString + "'}",
        dataType: "json",
        success: function (Result) {
            $('#ddlasssttype').empty();
   ...
   //    ModelPopWarning("Please Select Asset Type");
    ...
    if (bh_ritc == 1) {
        ...
        $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "BHAssetmanagement.aspx/confirmproblem",
                data: "{QueryString:'" + QueryString + "',input : '" + input + "'}",
                dataType: "json",
                success: function (Result) {
                    ...
                    window.open('BHAssetmanagement.aspx', '_self');                       
                },
...
function getgbTABLE() {
    ...
    Querystring = "GetGBSEARCH";
        ...
        $.ajax({
            type: "POST",
            contentType: "application/json; charset=utf-8",
            url: "BHAssetmanagement.aspx/getTableGB",
            data: "{QueryStr : '" + Querystring + "',input :'" + InputString + "'}",
            dataType: "json",
            success: function (Result) {
                if (Result.d.length > 0) {
...
function shAstDetails(AsstCd) {
    ...
    $.ajax({
        ...
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "BHassetmanagement.aspx/AssetV",
        data: "{QueryString:'" + QueryString + "',input : '" + input + "'}",
        dataType: "json",
        success: function (Result) {
            if (Result.d.length > 0) {
...
function shWRkSDetails(Asstcd) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "BHassetmanagement.aspx/WOKSTDET",
        data: "{QueryString:'" + QueryString + "',input : '" + input + "'}",
        dataType: "json",
        success: function (Result) {
...
function assetcode() {
    ...
    $.ajax({
        ...
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "BHAssetmanagement.aspx/getFillassescode",
        data: "{QueryString:'" + QueryString + "'}",
        dataType: "json",
        success: function (Result) {
