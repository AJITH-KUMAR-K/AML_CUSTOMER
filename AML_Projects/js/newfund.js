...
function AddLoanMst() {
    ...
    //}
        ...
        var DtAgrmntto = "";
         ...
         DtAgrmnt = Date.parse($("#txt_AgrmntDt").val());
        DtAgrmntfrm = Date.parse($("#txt_DtAgrmntFrm").val());
         DtAgrmntto = Date.parse($("#txt_DtAgrmntTo").val());
        ...
        if ($("#txt_DtAgrmntFrm").val() == "") {
            agrmtdtfrm = "";
        }
        if ($("#txt_DtAgrmntTo").val() == "") {
            agrmtdtto = "";
        }
