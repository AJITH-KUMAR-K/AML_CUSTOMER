        ...
        success: function (Result) {
            if (Result.d.length > 0) {
                ...
                for (var i = 0; i < Result.d.length; i++) {
                    ...
                    $('#assetdtl').append('<div class="card border-success mb-1 bg-light rounded" style="max-width:35rem;">' +
                        ' <div class="card-body" style="background-color:#f1f7f3;">' +
                        ' <div id="assetdtl" class="card-columns" style="column-count:3; column-gap: 0px;">' +
                        ...
                        ' <h5 class="card-text">' + Result.d[i].AsstNme + ' <h6>  ' + Result.d[i].Asstcode + '</h6></h5>' +
                        '<p class="card-text">' + Result.d[i].ManufName + '<br/>' + Result.d[i].AsstState + '<br/><br/><br/><br/><br/></p>' +
                        //'<p class="card-text">STATUS:'+ Result.d[i].AsstState + '</p>' +
                        '</div>' +
                        '<div class="d-block">' +
                        ...
                        '</div>' +
                        '<div class="d-inline">' +
                        '<select  class="form-control" id="ddlstatus"  style="width:100%" name="changestatus"> </select>'+
                        ' <select class="form-control"   id="ddlstatus"  style="width:100%" name="changestatus"> </select>'+
                        ' <select  class="form-control" id="ddlstatus"  style="width:100%" name="changestatus"> </select>'+
                         '<textarea  class="form-control" id="ddlstatus"  style="width:100%" name="changestatus" ></textarea>' +
                        '</div>' +
                        '</div>' +
